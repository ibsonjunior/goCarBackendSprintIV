create table booking (id integer not null auto_increment, final_day date, inital_day date, initial_time varchar(255), id_product integer, id_user bigint, primary key (id)) engine=MyISAM;
