-- Categories
INSERT INTO category (qualification, description, url_image) VALUES ('E S P O R T I V O', 'Foco no desempenho dinâmico para o condutor, além de uma velocidade acima da média de outros veículos e com muita liberdade para dirigir', 'https://gocar-grupo01.s3.amazonaws.com/categoria/sport_.jpg');
INSERT INTO category (qualification, description, url_image) VALUES ('E L É T R I CO', 'Carros elétricos não são movidos a base de combustão, e são exelentes para quem se preocupa meio-ambiente.', 'https://gocar-grupo01.s3.amazonaws.com/categoria/eletric_.jpg');
INSERT INTO category (qualification, description, url_image) VALUES ('L U X O', 'O termo luxo é usado para categorizar veículos que estão equipados com melhores capacidades de desempenho, interiores luxuosos e todos os últimos recursos de segurança e tecnologia', 'https://gocar-grupo01.s3.amazonaws.com/categoria/luxo_.jpg');
INSERT INTO category (qualification, description, url_image) VALUES ('S U V', 'A sigla SUV significa Sport Utility Vehicle -- ou seja, veículo utilitário esportivo. As SUVs costumam ter porte avantajado, além de interior espaçoso e possibilidade de trafegar dentro e fora da cidade.', 'https://gocar-grupo01.s3.amazonaws.com/categoria/suv_.jpg');
